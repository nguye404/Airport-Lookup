...
SOURCESA_CLNT.h =
SOURCESA_CLNT.cpp =
SOURCESA_SVC.h = kdTree.h
SOURCESA.x = airport.x 

# places required files
TARGETS_SVC.cpp = places_svc.cpp places_server.cpp places_xdr.cpp airport_xdr.cpp airport_clnt.cpp 
...
$(CLIENT) : $(OBJECTS_CLNT) 
	$(LINK.cpp) -std=c++11 -o $(CLIENT) $(OBJECTS_CLNT) $(LDLIBS)

#Airport client
$(CLIENTA) : $(OBJECTSA_CLNT) 
	$(LINK.cpp) -std=c++11 -o $(CLIENTA) $(OBJECTSA_CLNT) $(LDLIBS)

$(SERVER) : $(OBJECTS_SVC) 
	$(LINK.cpp) -std=c++11 -o $(SERVER) $(OBJECTS_SVC) $(LDLIBS)

#Airport server	
$(SERVERA) : $(OBJECTSA_SVC) 
	$(LINK.cpp) -std=c++11 -o $(SERVERA) $(OBJECTSA_SVC) $(LDLIBS)
	
places_client.o : places_client.cpp
	$(LINK.cpp) -std=c++11 -c -o places_client.o places_client.cpp

places_server.o : places_server.cpp
	$(LINK.cpp) -std=c++11 -c -o places_server.o places_server.cpp
